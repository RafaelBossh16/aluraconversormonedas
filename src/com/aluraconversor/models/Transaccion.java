...
public class Transaccion {
    ...
    public double obtenerTasa(String monedaOrigen, String monedaDestino)
    {
        ...
        // Hacer la conversión de JSON string to JsonObject
        JsonObject jsonObject = new Gson().fromJson(json, JsonObject.class);

        // Se obtiene el valor de la conversión de la api "conversion_rate"
        ...
        catch (NumberFormatException e)
        {
            ...
            {
                throw new ErrorException("No se pudo convertir por que apareció N/A ");
            }
        }
